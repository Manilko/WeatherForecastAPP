...
struct AppConstants {
    ...
    static let gmsPlacesClientKey: String = "AIzaSyDemoC72_iFFpqwa9ZB7YCTiqiNZiLmIoA"
    static let gmsServicesapiKey: String = "AIzaSyDemoC72_iFFpqwa9ZB7YCTiqiNZiLmIoA"
}
